...
export default function ProjectDropdown({ projects, value, onChange }) {
  ...
  return (
    <div ref={ref} className="relative flex-1 min-w-0">
      ...
      {open && (
        <div className="absolute z-50 top-full mt-1.5 left-0 right-0 rounded-xl border border-[#e8dff2] bg-white shadow-lg shadow-black/8 py-1.5 overflow-hidden">
          <button
            type="button"
            onClick={() => {
              onChange('');
            ...
            className="w-full text-left px-3 py-2 text-sm text-[var(--tm-text-muted)] hover:bg-[#f7f8f5] transition-colors"
          >
            Choose project
          </button>
